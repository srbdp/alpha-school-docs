...
| grade_levels_range | string | Span of grade levels served across network | PreK-12 (varies by campus) |
| tuition_range | string | Minimum and maximum annual tuition across all locations | \$10,000 - \$75,000/year |
| standard_operating_hours | string | Universal campus daily schedule | 8:15 AM - 4:00 PM |
| outdoor_play_minimum | string | Required daily outdoor time across all campuses | 60-90 minutes |
| student_guide_ratio | string | Staffing ratio maintained across network | 5:1 |
| expansion_campuses_planned | number | Announced Fall 2026 new locations | 5+ |

## Details

### Current Campus Network by State
...
- **Fort Worth**: 3300 Bryant Irvin Rd, Fort Worth, TX 76109 | K-8 | \$40,000/year | Contact: (817) 330-9327 / admissions.fortworth@alpha.school | Within CERA recreational facility, opened Fall 2025, serves Aledo/Tanglewood/Ridglea/Arlington/Keller/Southlake/Colleyville/Richardson/DFW metroplex
- **Plano**: 7220 Independence Pkwy, Plano, TX 75025 | K-5 | \$50,000/year | Dallas area
...
- **New York City**: 180 Maiden Lane, New York, NY 10038 | K-8 | \$65,000/year | Lower Manhattan, prestigious building, opened September 3, 2025
...
All Alpha School campuses follow a consistent operational model regardless of location:

**Operating Hours**: 8:15 AM - 4:00 PM daily with drop-off window 8:15-8:30 AM and pick-up window 3:30-4:00 PM.

**Academic Model**: Two-hour AI-powered personalized learning block using mastery-based progression where students advance upon demonstrating 90%+ competency in core subjects (reading, math, language, science, social studies).

**Afternoon Programming**: Life skills workshops including leadership, teamwork, entrepreneurship, financial literacy, public speaking, coding, and science labs.

**Outdoor Play**: Minimum 60-90 minutes daily (weather permitting) emphasizing physical activity and unstructured play.

**Staffing Model**: "Guides" who act as mentors/coaches rather than traditional lecture-based teachers, maintaining a 5:1 student-guide ratio across the network.

**Pedagogical Approach**: No homework, no traditional letter/number grades, capability-based levels rather than grade-based classes.

**All-Inclusive Tuition**: Covers trips (examples: Formula 1 events, Poland travel), supplies, and enrichment activities with a "no additional fundraising ever" policy distinguishing Alpha from traditional schools with add-on fees.

**Remote Option**: Alpha Anywhere provides online/remote learning for families not near a physical campus.

**Campus Leadership**: Typically includes Head Guide and Dean of Parents roles managing student instruction and family community integration respectively.
...
**Academic Features**: Two-hour AI-powered personalized learning block, mastery-based progression system, ranked in "top 1% nationally" for academic performance (per Alpha materials).

**Afternoon Programming**: Life skills workshops covering leadership, teamwork, entrepreneurship, and financial literacy.
...
Alpha School operates multiple specialty schools under its umbrella organizational structure:

**Texas Sports Academy**: Sport-specific schools combining Alpha's two-hour learning model with intensive athletic training at \$15,000/year tuition.

**Currently Open**:
- AIE Elite Prep basketball in Round Rock, TX (2400 Chisholm Trail Road, grades 5-8)
- The Bennett School baseball in Houston, TX (2626 W. Sam Houston Parkway N., grades 7-10)

**Opened January 2026**:
- Baseball in Pearland, TX (18500 Pearland Sites Road Bldg. D, grades 4-8)
- Basketball in Houston, TX (11275 S. Sam Houston Parkway W., grades 4-8)
- Gymnastics in San Antonio, TX (14242 Cross Canyon, grades 4-8)

**Opening Fall 2026**:
- Cheer in Lago Vista, TX (grades 5-8, specific address pending)

**Financial Context**: Texas ESA (Education Savings Account) program may provide approximately \$10,300 per student toward the \$15,000 tuition, reducing family cost to ~\$4,700/year.

**Other Specialty Schools**: GT School (\$25,000/year tuition documented for 2024-2025), Montessorium, NextGen Academy, Nova Academy, and Waypoint Academy—specific details, locations, and grade levels for these programs are not documented in public materials.

**Program Philosophy**: Specialty schools maintain Alpha's core two-hour AI learning block while tailoring afternoon programming to sport or focus area. The Texas Sports Academy model enables student-athletes to accelerate academics in the morning block while dedicating afternoon hours to elite-level sport training.
...
Alpha School has announced aggressive expansion targets for 2026 and beyond:
...
**Example 1: Austin Flagship Campus Experience**

A family lives in South Austin near the Barton Springs area and explores Alpha School for their 3rd grade child. They visit the Austin flagship campus at 1201 Spyglass Drive—a 10 minute drive from their home via MoPac. The campus, located in the Barton Hills neighborhood near Zilker Park, provides a familiar Austin environment. The family observes 150+ students engaged in a two-hour morning AI learning block with guides circulating to provide support. Campus features include outdoor play areas where students spend a minimum of 1 hour 15 minutes daily. The family learns the campus was established in 2016 (Year 11 of operation) and holds Cognia accreditation. Tuition is quoted at \$40,000/year for the 2024-2025 academic year—all-inclusive covering field trips, supplies, and enrichment with no additional fundraising requests. Hours align with the family's work schedule: drop-off 8:15-8:30 AM, pick-up 3:30-4:00 PM. The family contacts admissions at (512) 595-0801 or admissions.austin@alpha.school to schedule a Shadow Day.

INFORMATION STATUS: Austin flagship details documented from alpha.school/austin page and research sources; 150+ enrollment confirmed in public materials; Cognia accreditation verified; tuition from published materials; campus count (3 Austin locations: PreK-5, 6-8, 9-12) indicates vertical progression pathway within Austin market enabling students to remain in Alpha network through high school graduation.

**Example 2: Geographic Expansion Comparison - Brownsville vs. San Francisco**

Alpha School operates campuses in Brownsville TX and San Francisco CA, illustrating extreme tuition variance and market positioning strategy. **Brownsville Campus**: 591 N. Central Ave, Brownsville, TX 78521, serves PreK-8 students at \$10,000/year tuition (lowest in network); located near SpaceX headquarters in a border region with lower cost of living; \$10,000 tuition positions Alpha competitively against local private schools while remaining accessible to families with ESA vouchers or financial aid; the campus demonstrates Alpha's willingness to serve lower-income markets with adjusted pricing. **San Francisco Campus**: 3741 Buchanan St, San Francisco, CA 94123 (Marina/Fort Mason area), serves K-10 students at \$75,000/year tuition (highest in network); opened August 2025 as the 14th Alpha campus in a former Guidepost Montessori Fort Mason facility acquired through the Higher Ground Education asset deal; SF Standard described it as the "most expensive private school in the city," exceeding elite institutions like Convent & Stuart Hall (~\$50,000/year); \$75,000 tuition reflects San Francisco premium market positioning and high operational costs. Both campuses follow an identical operational model (8:15 AM - 4:00 PM, two-hour AI learning, 60-90 minutes outdoor play, life skills workshops, guides vs. teachers, no homework) despite the \$65,000 tuition difference. The tuition variance reflects local market conditions and family willingness-to-pay rather than a differentiated educational product.

INFORMATION STATUS: Tuition figures from research sources; Brownsville near SpaceX detail from research/locations.md; San Francisco opening date and facility history from PR Newswire and news sources; SF Standard comparison to Convent & Stuart Hall documented; identical operational model across network confirmed in standard features documentation.

**Example 3: Texas Sports Academy Multi-Location Model**

A family in the Houston area has a 6th grade child excelling in competitive baseball and seeking an academic program compatible with intensive training schedules. The family explores The Bennett School (Texas Sports Academy baseball campus) at 2626 W. Sam Houston Parkway N., Houston, TX 77043, serving grades 7-10. The school combines Alpha's two-hour AI-powered learning block with afternoon baseball-specific training, enabling student-athletes to accelerate academics while dedicating significant time to sport development. Tuition is quoted at \$15,000/year—significantly lower than standard Alpha campuses (\$40,000-\$75,000), reflecting the targeted market and specialized focus. The family learns that the Texas ESA program may provide approximately \$10,300 per student, reducing family cost to ~\$4,700/year. Since their child is currently in 6th grade, the family plans enrollment for the following year when entering 7th grade (minimum grade for The Bennett School). The family also considers the newly opened January 2026 baseball campus in Pearland, TX (18500 Pearland Sites Road, grades 4-8), which offers an earlier entry point. The model enables the child to complete core academics in the morning two-hour block (reading, math, language, science, social studies via AI platform with mastery-based progression) then transition to baseball training, strength/conditioning, and game strategy in the afternoon hours. If the child later decides to pursue a different path or reduce sport intensity, they can transfer to a standard Alpha campus (Houston area has multiple Alpha/specialty locations). The Texas Sports Academy network includes basketball (Round Rock, Houston locations), gymnastics (San Antonio), and cheer (Lago Vista Fall 2026), providing sport-specific pathways across Texas markets.

INFORMATION STATUS: The Bennett School details from research/locations.md citing Community Impact article; \$15,000 tuition and grade levels documented; Texas ESA ~\$10,300 figure from research sources; January 2026 Pearland opening from research; two-hour learning block + sport training model inferred from Alpha's standard academic structure applied to specialty school context; transfer flexibility between Alpha campuses represents logical operational capability though not explicitly documented in public materials.

## Related

- [Enrollment Process](../enrollment/process.md) - How to enroll at specific campus locations
- [Enrollment Tuition](../enrollment/tuition.md) - Detailed tuition by location
- [Contact Overview](../contact/overview.md) - Campus-specific contact information
- [Organization Overview](../organization/overview.md) - Alpha School founding and organizational context
- [Organization History](../organization/history.md) - Timeline of campus openings and expansion
- [Educational Philosophy](../model/educational-philosophy.md) - Learning model implemented across all campuses
- [Two-Hour Learning Model](../model/two-hour-learning.md) - Core academic approach used at every location
- [Daily Schedule](../model/daily-schedule.md) - Standard daily routine across campus network
- [Expansion Plans](./expansion.md) - Detailed expansion roadmap and future locations (Spec 022)
