...
**Last Updated**: 2026-01-20 (Spec 004 Spec Created)
...
**Total Specs**: 32 | **Completed**: 9 (28.1%) | **In Progress**: 1 (3.1%) | **Planned**: 22 (68.8%) | **Estimated Effort**: ~20 hours
...
| 004 | 🚧 In Progress | High | 002 | Leadership - founders, key people (public only) | `reference/organization/leadership.md` | Small |
...
| Spec | Status | Priority | Dependencies | Description | Output | Effort |
|------|--------|----------|--------------|-------------|--------|--------|
| 006 | 📋 Planned | Critical | 001 | Educational philosophy - core approach | `reference/model/educational-philosophy.md` | Small |
...
| Spec | Status | Priority | Dependencies | Description | Output | Effort |
|------|--------|----------|--------------|-------------|--------|--------|
| 011 | 📋 Planned | High | 006 | Curriculum overview and philosophy | `reference/curriculum/overview.md` | Small |
| 012 | 📋 Planned | High | 011 | Subjects - what is taught | `reference/curriculum/subjects.md` | Small |
...
| Spec | Status | Priority | Dependencies | Description | Output | Effort |
|------|--------|----------|--------------|-------------|--------|--------|
| 015 | 📋 Planned | High | 001 | Claims - what Alpha claims (with appropriate caveats) | `reference/outcomes/claims.md` | Medium |
...
| Spec | Status | Priority | Dependencies | Description | Output | Effort |
|------|--------|----------|--------------|-------------|--------|--------|
| 019 | 📋 Planned | Critical | 001 | Enrollment process and eligibility | `reference/enrollment/process.md` | Small |
| 020 | 📋 Planned | High | 019 | Tuition and financial aid (if public) | `reference/enrollment/tuition.md` | Small |
